# Jad Menkara
# left_classifier.py
# Used to track the person on the left and send updated controls to the server
...
def calculate_angle(point1, point2, point3):
    ...
    # we can then rearrange cosine law to get the angle between the 3 points
...
class point:
    def __init__(self, x, y):  # point class containing x and y values
        self.x = x
        self.y = y
    def getY(self):
        return self.y
...
def run_code():
    ...
    while True:
        ...
        if results_pose.pose_landmarks:
            mp_drawing.draw_landmarks( #draws the landmarks for your current pose
                frame, 
        ...
        "moving": 0
            ...
            print(isMoving(x_values, w))
             ...
             #checks if you're moving and updates the payload to be sent
        ...
        cv2.imshow("Left_Classifier", frame)
